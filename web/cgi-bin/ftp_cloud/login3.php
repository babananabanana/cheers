...
<?php
	...
	ob_end_clean();
	header('Locaton:ftp.html');
	exit();
 			} else {
 				print '<p>the submitted username && password do not match<br />please try again.</p>';
 			} 
 		} else {
 			print '<p>please make sure you enter both username && password</br /></p>';
 		}
 	} else 
